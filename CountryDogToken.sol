...
contract CountryDogToken is Context, ERC20, Ownable {

    string internal constant _name = "Country Dog";
    string internal constant _symbol = "CDog";
    uint256 public constant INIT_TOTALSUPPLY = 10000000000*10**18;

    constructor () public ERC20(_name, _symbol, INIT_TOTALSUPPLY, _msgSender()) Ownable(_msgSender()) {
